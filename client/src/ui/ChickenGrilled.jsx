...
function ChickenGrilled() {
  ...
  function handleAddToCart() {
    const sandwish1 = {
      ...
      sandwichName: "ChickenGrilled",
      sandwichDetails: sandwishDetails,
      sandwichQuantity: quantity,
      sandwichPrice: 30,
      sandwishCals,
      sandwichTotalPrice: 30 * quantity,
    };
  ...
  useEffect(() => {
    if (!hasAddedItemsRef.current) {
      ...
      dispatch(
        addVeggies({
          id: "6646df0ec4c787eb311f7914",
          cal: 180,
          title: "Grilled Chicken",
          kind: "Grilled Chicken",
        })
      );
  ...
  return (
    <Container>
      <ProductItem />
      <Img src="/img/2.jpg" alt="ChickenGrilled" />
